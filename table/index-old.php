...
$url = $urlPrefix . 'ws_get_table-old.php';
...
<div id="table-div">
    <table style="font-size: 12px; font-family: Verdana; border-collapse: collapse;">
        <thead>
        <tr>
            <th><a class="matid-th" style="text-decoration: none;">MAT_ID</a></th>
            <th><a class="model-th" style="text-decoration: underline;">MODEL</a></th>
            <th><a class="name-th" style="text-decoration: underline;">NAME</a></th>
        </tr>
        </thead>
        <tbody>
...
<script>
    ...
    jQuery('.matid-th').click(function () {
        ...
        recreateTbody();
        jQuery('.matid-th').css('text-decoration', 'none');
        jQuery('.model-th').css('text-decoration', 'underline');
        jQuery('.name-th').css('text-decoration', 'underline');
    });

    jQuery('.model-th').click(function () {
        dataArray.sort(sModel);
        recreateTbody();
        jQuery('.matid-th').css('text-decoration', 'underline');
        jQuery('.model-th').css('text-decoration', 'none');
        jQuery('.name-th').css('text-decoration', 'underline');
    });
    ...
    jQuery('.name-th').click(function () {
        ...
        jQuery('.matid-th').css('text-decoration', 'underline');
        jQuery('.model-th').css('text-decoration', 'underline');
        jQuery('.name-th').css('text-decoration', 'none');
    });
